...
public class RequestTest extends BaseTestCase {
    ...
    public void testNullCookie() throws Exception {
        app.get("/cookie", (req, res) -> res.text(req.cookie("user-id").orElse("null")));
    ...
    public void testGetCookies() throws Exception {
        app.get("/cookie", (req, res) -> res.text(req.cookies().toString()));
        assertThat(getBody("/cookie"), is("{}"));
    }

    @Test
    public void testMultipleCookies() throws Exception {
        app.get("/cookie", (req, res) -> res.json(req.cookies()));
    ...
    public void testPathParam() throws Exception {
        ...
        app.get("/user2/:id", (req, res) -> res.text(req.pathLong("id").toString()));
        app.get("/user3/:name/:age", (req, res) -> res.text(req.pathString("name") + ":" + req.pathString("age")));
